...
public class MqttDemoTest {
	...
	private MqttClient connect() throws MqttException, MqttSecurityException {
		final MqttClient result = new MqttClient("tcp://192.168.3.3", "demo", new MemoryPersistence());
